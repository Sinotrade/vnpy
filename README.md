...
* 推荐使用vn.py团队为量化交易专门打造的Python发行版[VNStudio-2.1.0](https://download.vnpy.com/vnstudio-2.1.0.exe)，内置了最新版的vn.py框架以及VN Station量化管理平台，无需手动安装
